...
class Worker implements Runnable {
   ...
   private static final int HEALTH_ALIVE = 0;

   private static final int HEALTH_DYING = 1;

   private static final int HEALTH_DEAD = 2;
   ...
   /**
    *  Attempt to mark the Worker as dead (if it's already dying); Note that
    *  we synchronize this method since it's mutating a shared object (this
    *  class)
    *
