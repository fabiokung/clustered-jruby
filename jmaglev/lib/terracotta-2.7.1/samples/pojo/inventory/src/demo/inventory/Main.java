...
public class Main {
   ...
   private void menu_main() {
      ...
      out.println("This sample application shows how to use Terracotta DSO to share and");
      out.println("propagate changes to data structures.");
      out.println();

      out.println("To perform an action, press the key encased in the square-brackets");
      out.println("from the list of options presented.");
      out.println();

      out.println("Press the [H] key for detailed information on each action.");
      out.println();
      while (true) {
         out.println();
         ...
         out.println("| [I]nventory  [D]epartments  [U]pdate              [H]elp  [Q]uit |");
   ...
   private void printHelp() {
      ...
      out.println("Press the key that correspond the action that you wish to perform");
      ...
      out.println("This will list the contents of the inventory, grouped by the");
      out.println("department that owns the inventory item.");
      out.println();
      out.println("[U]pdate:");

      out.println("Takes you into 'edit' mode to change the 'price' field value");
