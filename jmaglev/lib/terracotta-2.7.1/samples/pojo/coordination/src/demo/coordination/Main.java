...
/**
 *  Sample to demonstrate how to instrument things like CyclicBarrier and use
 *  them as a distributed mechanism.
 *
...
public class Main {
   ...
   /**
    *  Create an instance, setting the number of VMs expected to participate
    *  in the demo.
    *
    *@param  expectedParticipants  Description of Parameter
    */
   ...
   public void run() {
      try {
         ...
         System.out.println(text1.replaceFirst("@TOKEN@",
               Integer.toString(expectedParticipants)));
         ...
         System.out.println(text2.replaceFirst("@TOKEN@",
               this + Integer.toString(expectedParticipants))
               .replaceFirst("@TOKEN@", currentDateAndTime));
