...
/**
 *  DeleteFromListForm represents the form data submitted from the display
 *  page. The ActionServlet populates this form when a request for deletion is
 *  received from the display page.
 *
