...
/**
 *  Web controller for the Events sample application; provides the list of
 *  current messages and publishes new messages as events to the {@link
 *  ApplicationContext}, which is distributed by Terracotta for Spring.
 *
